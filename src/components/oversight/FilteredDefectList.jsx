...
const COMPONENT_NAME = 'FilteredDefectList';
...
const FilteredDefectList = ({ filters: externalFilters }) => {
  ...
  useEffect(() => {
    ...
    if (externalFilters && typeof externalFilters === 'object') {
      if (externalFilters.severity && typeof externalFilters.severity === 'string') {
        initialFilters.severity = externalFilters.severity;
      }
      ...
      if (externalFilters.startDate && typeof externalFilters.startDate === 'string') {
        initialFilters.startDate = externalFilters.startDate;
      }
      if (externalFilters.endDate && typeof externalFilters.endDate === 'string') {
        initialFilters.endDate = externalFilters.endDate;
      }
    }

    const urlSeverity = searchParams.get('severity');
    if (urlSeverity && typeof urlSeverity === 'string') {
      initialFilters.severity = urlSeverity;
    }
    ...
    if (urlStartDate && typeof urlStartDate === 'string') {
      initialFilters.startDate = urlStartDate;
    }

    const urlEndDate = searchParams.get('endDate');
    if (urlEndDate && typeof urlEndDate === 'string') {
      initialFilters.endDate = urlEndDate;
    }
  ...
  const filteredDefects = useMemo(() => {
    ...
    if (localFilters.severity && typeof localFilters.severity === 'string') {
      defectFilters.severity = localFilters.severity;
    }

    if (localFilters.status && typeof localFilters.status === 'string') {
      defectFilters.status = localFilters.status;
    }

    if (localFilters.rootCause && typeof localFilters.rootCause === 'string') {
      defectFilters.rootCause = localFilters.rootCause;
    }

    if (localFilters.search && typeof localFilters.search === 'string') {
      defectFilters.search = localFilters.search;
    }

    if (localFilters.startDate && localFilters.startDate.trim() !== '') {
      defectFilters.startDate = localFilters.startDate;
    }

    if (localFilters.endDate && localFilters.endDate.trim() !== '') {
      defectFilters.endDate = localFilters.endDate;
    }
...
FilteredDefectList.defaultProps = {
  filters: null,
};

export default FilteredDefectList;